...
# Prove properties
# 1st pass: 1 hour of autoproving
set_prove_time_limit 1h
echo "Pass1_Start: " [date +%s]
set_max_trace_length 50
autoprove -all -asserts
echo "Pass1_End: " [date +%s]
echo "AUTOPROVE_PASS_REPORT_BEGIN"
report
echo "AUTOPROVE_PASS_REPORT_END"

#
# 2nd pass: Validation of remaining properties with different engine
# 9 hours
set_prove_time_limit 9h
echo "Pass2_Start: " [date +%s]
set_max_trace_length 50
set_prove_per_property_time_limit 1000s
set_prove_per_property_time_limit_factor 2
set_engine_mode {K I N AD AM}
prove -all -asserts
